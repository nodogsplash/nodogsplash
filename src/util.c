...
static int
get_client_mac_proc(char mac[18], const char ip[], int len)
{
	FILE *f;
	char line[256] = {};
...
static int
get_client_mac_iproute(char mac[18], const char ip[], int len)
{
	FILE *f;
	char line[256] = {};
